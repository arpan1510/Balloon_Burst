...
class HandTracking:
    def __init__(self):
        self.handtracking = mp_hands.Hands(min_detection_confidence=0.5, min_tracking_confidence=0.5)
        self.hand_x = 0
        self.hand_y = 0
        self.results = None
    ...
    def scan_hands(self, image):
        ...
        self.results = self.handtracking.process(image)
        ...
        if self.results.multi_hand_landmarks:
            for hand_landmarks in self.results.multi_hand_landmarks:
                ...
                self.hand_x = int(x * 1280)
                self.hand_y = int(y * 720)
